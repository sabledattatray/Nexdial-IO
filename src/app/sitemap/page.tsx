...
export default function HTMLSitemapPage() {
  const categories = [
    ...
    },
    {
      ...
      color: "#EF4444",
      links: [
        { label: "Knowledge Center", href: "/knowledge-center", desc: "WhatsApp configuration templates and CSV lead importing guides" },
        ...
        { label: "Request Demo System", href: "/request-demo", desc: "Deploy a sandbox CRM instance and explore features" },
        { label: "Book Consultation Slot", href: "/book-consultation", desc: "Solutions architecture scoping sessions" },
        { label: "Privacy Policy Document", href: "/privacy", desc: "Data privacy policy and client communication guidelines" },
